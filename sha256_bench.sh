...
hyperfine './cpu_air_prover     --out_file=../../sha256/sha256_proof.json     --private_input_file=../../sha256/private_input.json --public_input_file=../../sha256/public_input.json     --prover_config_file=../../sha256/cpu_air_prover_config.json --parameter_file=../../sha256/cpu_air_params.json     --generate_annotations' --show-output > sha256_$1_air_prover.txt

echo "Benchmarking Stone Air Verifier for Keccak on $1 bytes"
hyperfine './cpu_air_verifier --in_file=../../sha256/sha256_proof.json' --show-output > sha256_$1_air_verifier.txt
...
hyperfine 'cairo-run --program=cairo_verifier.json --layout=recursive --program_input=cairo_verifier_input.json --trace_file=cairo_verifier_trace.json --memory_file=cairo_verifier_memory.json --print_output' --show-output > sha256_$1_cairo_verifier.txt
cd ..
