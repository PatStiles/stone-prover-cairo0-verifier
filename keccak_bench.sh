...
hyperfine './cpu_air_prover     --out_file=../../keccak/keccak_proof.json     --private_input_file=../../keccak/private_input.json --public_input_file=../../keccak/public_input.json     --prover_config_file=../../keccak/cpu_air_prover_config.json --parameter_file=../../keccak/cpu_air_params.json     --generate_annotations' --show-output > keccak_$1_air_prover.txt

echo "Benchmarking Stone Air Verifier for Keccak on $1 bytes"
hyperfine './cpu_air_verifier --in_file=../../keccak/keccak_proof.json' --show-output > keccak_$1_air_verifier.txt
...
hyperfine 'cairo-run --program=cairo_verifier.json --layout=recursive --program_input=cairo_verifier_input.json --trace_file=cairo_verifier_trace.json --memory_file=cairo_verifier_memory.json --print_output' --show-output > keccak_$1_cairo_verifier.txt
cd ..
